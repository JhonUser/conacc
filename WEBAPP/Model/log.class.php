  ...
  class Login{
    public static function validar($name){
      try {
        ...
        $consul = "SELECT usuario.usu_cod, usuario.usu_nom, usuario.usu_nick, usuario.usu_pass, rol.rol_cod, rol.rol_nombre FROM rol
                   INNER JOIN usuario ON rol.rol_cod = usuario.rol_cod AND usuario.usu_nick = ?";
