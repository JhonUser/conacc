 ...
 <div class="row">
		 <div class="card">
			 <div class="card-action lime darken-3">
				 <button type="button" class="btn lime darken-3 z-depth-0 white-text thin" style="margin-left:25%">Registro de usuario</button>
			 </div>
		...
		<div class="row">
			...
			<div class="card-action grey lighten-3">
				<button class="waves-effect waves-light btn teal thin" value="Guardar" name="action">Guardar</button>
					</form>
			</div>
  	</div>
